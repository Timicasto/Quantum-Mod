...
public class PrimedIce extends EntityTNTPrimed {
    ...
    public IceBoom createExplosion(@Nullable Entity entityIn, double x, double y, double z, float strength, boolean isFlaming, boolean isSmoking) {
        IceBoom explosion = new IceBoom(this.world, entityIn, x, y, z, strength, isFlaming, isSmoking);
