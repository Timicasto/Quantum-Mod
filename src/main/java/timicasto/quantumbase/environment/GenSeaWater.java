...
public class GenSeaWater extends ChunkGeneratorOverworld {

    private IBlockState oceanBlock = QuantumBaseBlocks.seaWater.getDefaultState();
    private Biome[] biomesForGeneration;
    private final World world;
    private ChunkGeneratorOverworld chunkGeneratorOverworld;
    ...
    public GenSeaWater(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions, World world) {
