...
public class CustomBoom extends Explosion {
    ...
    public CustomBoom(World worldIn, Entity entityIn, double x, double y, double z, float size, List<BlockPos> affectedPositions) {
        this(worldIn, entityIn, x, y, z, size, false, true, affectedPositions);
    }

    @SideOnly(Side.CLIENT)
    public CustomBoom(World worldIn, Entity entityIn, double x, double y, double z, float size, boolean causesFire, boolean damagesTerrain, List<BlockPos> affectedPositions) {
        this(worldIn, entityIn, x, y, z, size, causesFire, damagesTerrain);
        this.affectedBlockPositions.addAll(affectedPositions);
    }

    public CustomBoom(World worldIn, Entity entityIn, double x, double y, double z, float size, boolean flaming, boolean damagesTerrain) {
     ...
     */
    public void doExplosionA(int range) {
        Set<BlockPos> set = Sets.<BlockPos>newHashSet();
        int offset = range / 2 + 1;

        //Edit Below
        BlockPos blockPos = new BlockPos(x, y, z).down(offset).west(offset).north(offset);
