...
public class OreFeatureConf {
	 ...
	 */
	public OreFeatureConf(int bottomOffset, int topOffset, int maximum, int maxSize, int perChunk) {
	 ...
	 */
	public OreFeatureConf(int minHeight, int maxHeight, int maxSize, int perChunk) {
